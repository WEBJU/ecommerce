                                    ...
                                    <div class="col-lg-6 col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="country" id="country">
                                                <option value="AF">Madaraka</option>
                                                <option value="AX">Highrise</option>
                                                <option value="AL">Upper Hill</option>
                                                <option value="DZ">Kilimani</option>
                                                <option value="AS">Westlands</option>
                                                <option value="AD">Langata</option>
                                                <option value="AO">South C</option>
                                                <option value="AI">Embakasi</option>
                                                <option value="AQ">Juja</option>
                                                <option value="AG">Thika</option>
                                                <option value="AR">Ruiru</option>
                                              </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6 col-12">
