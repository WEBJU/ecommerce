...
<head>
  <title>Ecommerce App | Login Page</title>
...
<body class="bg-gradient-danger">
  ...
  <div class="container">
    ...
    <!-- Outer Row -->
    <div class="row justify-content-center foget">
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Admin/Vendor Login</h1>
                  </div>
                  ...
                  <div class="text-center">
                    @if (Route::has('password.request'))
                        <a class="btn btn-link small text-danger" href="{{ route('password.request') }}">
